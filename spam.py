...
def banner():
    ...
    autoketik (f"""
     ...
     \033[1;0m──────────────────────────┬─────────────────────────
  \033[1;0m┌────────────────────────────┼───────────────────────────┐
  {W}│ Creator{R}:{W}Fahad           │ Version {R}:{G} 3.0{W}            │
 {W} | Addition{R}:{W}Fahad           |                     {W}                          |
  {W}│ Github{R}:{G}tidak ada  {W}│  {W}Your Ip {R}:{Y} {ip}     {W}│
  {W}│ Youtube{R}:{W}FAHAD {biru} channel       {W}│ Perfect Brutal {biru}Sms Tools  {W}│
  └────────────────────────────┼───────────────────────────┘""")
